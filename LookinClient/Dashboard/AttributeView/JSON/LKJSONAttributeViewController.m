...
@interface LKJSONAttributeViewController () <LKTableViewDelegate, LKTableViewDataSource>
...
- (NSTableRowView *)tableView:(NSTableView *)tableView rowViewForRow:(NSInteger)row {
    ...
    LKOutlineRowView *view = (LKOutlineRowView *)[tableView makeViewWithIdentifier:@"myView" owner:self];
    if (!view) {
        view = [LKOutlineRowView new];
